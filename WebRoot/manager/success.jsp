...
<div class="box w1180">
	...
	<p style="width: 100%;text-align: center;font-size: 20px;margin-top: 20px;"> 添加成功</p>
	<p style="width: 100%;text-align: center;font-size: 15px;margin-top: 20px;">
	<font id="id8" size="6">5</font>秒钟后返回或<a  href="${ctx}/register.jsp" style="color: #f00;font-size: 20px;">点击我直接跳转</a></p>
