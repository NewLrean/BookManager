...
<h1>注册页面</h1>
<h5>*为必填内容</h5>
<form class="form-horizontal" action="${ctx }/StudentServlet?mothed=register" method="post">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-3 control-label">用户名*</label>
    <div class="col-sm-9">
      <input  class="form-control" name="name" id="inputEmail" pattern="[A-z_0-9]{6,20}" required="required" title="由字母、数字或_组成，长度不小于6位，不多于20位" placeholder="Username">
    </div>
  </div>
  <div class="form-group">
